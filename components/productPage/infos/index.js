          ...
          {product.colors &&
            product.colors.map((color, index) => (
              <span
                className={`
                                    ${
                                      index == router.query.style
                                        ? styles.active_color
                                        : ""
                                    }
                                `}
                onMouseOver={() =>
                  setActiveImage(product.subProducts[index].images[0].url)
                } // TODO a fix here is needed, as the active image is not updating on mouse over / mouse leave
